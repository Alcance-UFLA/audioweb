	...
	<div class="container">
		<div class="row margem-inferior">
			<div class="col-md-8 col-md-offset-2">
				...
				<p>O AudioWeb é uma realização da empresa Polaris e do núcleo Alcance. A <a href="http://www.polarisweb.com.br/">Polaris Inovações em Soluções Web</a> é uma empresa de base tecnológica fundada para criar inovações para educação inclusiva, organização de eventos, comércio e marketing online, que está sendo incubada na Inbatec/UFLA, Lavras, ao sul de Minas Gerais. O Alcance é o Núcleo de Pesquisas em Acessibilidade, Usabilidade e Tecnologia Assistiva, integrante da rede nacional de núcleos de pesquisas em tecnologia assistiva do <abbr title="Centro Nacional de Referência em Tecnologia Assistiva">CNRTA</abbr>.</p>
				<p>O AudioWeb é composto de 3 módulos: AudioImagem, AudioFórmula e AudioAula. Apresenta­-se a seguir uma descrição resumida deles.</p>
				</div>
			</div>
		</div>
		...
		<div id ="caracteristicas" class="row">
			...
			<div class="col-md-4">
				...
				<article class="panel panel-2" itemscope="itemscope" itemtype="http://schema.org/WebPageElement">
					...
					<div class="panel-body" itemprop="text">
						<p>O <em>AudioFórmula</em> é um módulo que permite editar e audiodescrever fórmulas matemáticas, desde símbolos matemáticos simples até fórmulas matemáticas complexas, tais como somatório, derivada e integral. Uma vez editadas, o AudioFórmula permite que os usuários, com ou sem deficiência visual, possam ouvir e compreender corretamente as fórmulas matemáticas. Este módulo ainda não está pronto.</p>
					</div>
				</article>
				<?php HTML::end_block() ?>
			</div>
