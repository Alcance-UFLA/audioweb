...
<section id="conteudo-principal" class="container" role="main">
	...
	<div class="row">
		<div class="col-md-6 text-center">
			<img class="img-responsive" src="#TODO" alt="Logomarca da empresa Polaris Inovações em Soluções Web" />
		</div>
		<div class="col-md-6 text-center">
			<img class="img-responsive" src="#TODO" alt="Logomarca provisória do Alcance, Núcleo de Pesquisas em Acessibilidade, Usabilidade e Tecnologia Assistiva" />
		</div>
	</div>
	<div class="row">
		<div class="col-lg-12">
			...
			<p>//TODO Logomarcas dos Parceiros: CNPq, CNRTA, NAUfla, Inbatec/Ufla, DCC/Ufla, CENAV</p>
		</div>
	</div>
</section>
<?php HTML::end_block() ?>