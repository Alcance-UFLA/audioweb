...
<section id="conteudo-principal" class="container" role="main">
	...
	<footer id="area-botoes" class="well">
		...
		<a class="btn btn-lg btn-default" href="<?= Route::url('acao_id', array('directory' => 'audioimagem', 'controller' => 'exibir', 'id' => $form_imagem['dados']['imagem']['id_imagem']))?>"><i class="glyphicon glyphicon-eye-open"></i> Exibir imagem</a>
	</footer>
</section>
<?php HTML::end_block() ?>