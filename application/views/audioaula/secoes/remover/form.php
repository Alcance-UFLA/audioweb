<?= Form::open(Route::url('remover_secao', array('id_aula' => $secao['aula']['id_aula'], 'id_secao' => $secao['id_secao'], 'action' => 'salvar')), array('class' => 'form-horizontal')) ?>
	...
	<div class="form-group">
		<div class="col-lg-offset-4 col-lg-8">
			...
			<a class="btn btn-default btn-lg" href="<?= Route::url('listar_secoes', array('id_aula' => $secao['aula']['id_aula'])) ?>"><i class="glyphicon glyphicon-chevron-left"></i> Voltar</a>
		</div>
	</div>
<?= Form::close() ?>