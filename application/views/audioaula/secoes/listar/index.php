...
<section id="conteudo-principal" class="container" role="main">
	...
	<footer class="well">
		...
		<a class="btn btn-default btn-lg" href="<?= Route::url('acao_id', array('directory' => 'audioaula', 'controller' => 'exibir', 'id' => $aula['id_aula'])) ?>"><i class="glyphicon glyphicon-eye-open"></i> Exibir Aula</a>
		<span class="sr-only">,</span>&nbsp;
