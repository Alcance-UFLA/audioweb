<?= Form::open(Route::url('remover_texto_secao', array('id_aula' => $aula['id_aula'], 'id_secao' => $secao['id_secao'], 'id_secao_texto' => $texto_secao['id_secao_texto'], 'action' => 'salvar')), array('class' => 'form-horizontal')) ?>
