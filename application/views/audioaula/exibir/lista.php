		...
		<article>
			...
			<div class="content">
				...
				<figure class="thumbnail">
					...
					<figcaption class="caption text-center"><a href="<?= Route::url('acao_id', array('directory' => 'audioimagem', 'controller' => 'exibir', 'id' => $item['imagem']['id_imagem'])) . '?' . http_build_query(array('id_aula' => $aula['id_aula'])) ?>"><?= HTML::chars($item['imagem']['nome']) ?></a></figcaption>
				</figure>
				<?php endif ?>
				<?php endforeach ?>
			</div>
